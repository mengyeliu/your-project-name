...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mengyeliu/your-project-name/main)
...
git branch -M main
git remote add origin https://github.com/mengyeliu/your-project-name.git
